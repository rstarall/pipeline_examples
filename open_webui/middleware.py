                    ...
                    if block["type"] == "text":
                        ...
                        if processing_duration is not None:
                            if raw:
                                ...
                                content = f'{content}\n<details type="processing" done="true" duration="{processing_duration}" title="{html.escape(processing_title)}">\n<summary>{processing_title} for {processing_duration} seconds</summary>\n{processing_display_content}\n</details>\n'
                        else:
                            if raw:
                                content = f'{content}\n<{block.get("start_tag", "processing")}>{block["content"]}<{block.get("end_tag", "/processing")}>\n'
                            else:
                                content = f'{content}\n<details type="processing" done="false" title="{html.escape(processing_title)}">\n<summary>{processing_title}…</summary>\n{processing_display_content}\n</details>\n'
